...
const MapExploreScreen = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      const data = await DataService.getAllValues();
      if (data) {
        const transformed = DataService.transformToMarkers(data);
  ...
  const filteredMarkers = DataService.filterMarkers(markers, activeFilter);
